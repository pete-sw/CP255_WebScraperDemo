...
class MySpider(Spider):
	...
	# [dan] tries to load the csv we made with craigslistRentSpider.py. Gets a list of each individual listing's URL
	# [dan] we will be crawling through these individual listings
	try:
